...
class InvoiceReconciliationRecordInvoiceLinkService {
    ...
    * @param {*} [options] Override http request options.
    */
    link(spaceId, recordId, completionId, amount, options = {}) {
        ...
        if (recordId !== undefined) {
            localVarQueryParameters['recordId'] = ObjectSerializer_1.ObjectSerializer.serialize(recordId, "number");
        }
        if (completionId !== undefined) {
            localVarQueryParameters['completionId'] = ObjectSerializer_1.ObjectSerializer.serialize(completionId, "number");
        }
        if (amount !== undefined) {
            localVarQueryParameters['amount'] = ObjectSerializer_1.ObjectSerializer.serialize(amount, "number");
        }
        Object.assign(localVarHeaderParams, options.headers);
        let defaultHeaderParams = {
            "x-meta-sdk-version": "3.2.1",
        ...
        return new Promise((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    ...
                    if (response.statusCode) {
                        if (response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer_1.ObjectSerializer.deserialize(body, "InvoiceReconciliationRecordInvoiceLink");
                            return resolve({ response: response, body: body });
                        }
                        else {
                            let errorObject;
        ...
        return new Promise((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    ...
                    if (response.statusCode) {
                        if (response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer_1.ObjectSerializer.deserialize(body, "Array<InvoiceReconciliationRecordInvoiceLink>");
                            return resolve({ response: response, body: body });
                        }
                        else {
                            let errorObject;
    ...
    * @param {*} [options] Override http request options.
    */
    unlinkTransaction(spaceId, recordId, completionId, options = {}) {
