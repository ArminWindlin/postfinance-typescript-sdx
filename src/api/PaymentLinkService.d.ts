...
declare class PaymentLinkService {
    ...
    * @param {*} [options] Override http request options.
    */
    create(spaceId: number, entity: PaymentLinkCreate, options?: any): Promise<{
        response: http.IncomingMessage;
        body: PaymentLink;
    }>;
    /**
    ...
    * @param {*} [options] Override http request options.
    */
    update(spaceId: number, entity: PaymentLinkUpdate, options?: any): Promise<{
        response: http.IncomingMessage;
        body: PaymentLink;
    }>;
}
