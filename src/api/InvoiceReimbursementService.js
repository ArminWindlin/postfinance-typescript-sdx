...
class InvoiceReimbursementService {
        ...
        return new Promise((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    ...
                    if (response.statusCode) {
                        if (response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer_1.ObjectSerializer.deserialize(body, "InvoiceReimbursement");
                            return resolve({ response: response, body: body });
                        }
                        else {
                            let errorObject;
        ...
        return new Promise((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    ...
                    if (response.statusCode) {
                        if (response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer_1.ObjectSerializer.deserialize(body, "Array<InvoiceReimbursementWithRefundReference>");
                            return resolve({ response: response, body: body });
                        }
                        else {
                            let errorObject;
    ...
    * @param {*} [options] Override http request options.
    */
    updateConnector(spaceId, id, paymentConnectorConfigurationId, options = {}) {
        ...
        if (paymentConnectorConfigurationId !== undefined) {
            localVarQueryParameters['paymentConnectorConfigurationId'] = ObjectSerializer_1.ObjectSerializer.serialize(paymentConnectorConfigurationId, "number");
        }
        Object.assign(localVarHeaderParams, options.headers);
        let defaultHeaderParams = {
            "x-meta-sdk-version": "3.2.1",
    ...
    * @param {*} [options] Override http request options.
    */
    updateIban(spaceId, id, recipientIban, senderIban, options = {}) {
        ...
        if (recipientIban !== undefined) {
            localVarQueryParameters['recipientIban'] = ObjectSerializer_1.ObjectSerializer.serialize(recipientIban, "string");
        }
        if (senderIban !== undefined) {
            localVarQueryParameters['senderIban'] = ObjectSerializer_1.ObjectSerializer.serialize(senderIban, "string");
        }
        Object.assign(localVarHeaderParams, options.headers);
        let defaultHeaderParams = {
            "x-meta-sdk-version": "3.2.1",
