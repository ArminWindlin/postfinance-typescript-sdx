...
declare class ShopifyRecurringOrderService {
    ...
    */
    search(spaceId: number, query: EntityQuery, options?: any): Promise<{
        response: http.IncomingMessage;
        body: Array<ShopifyRecurringOrder>;
    }>;
    /**
    ...
    * @param {*} [options] Override http request options.
    */
    update(spaceId: number, updateRequest: ShopifyRecurringOrderUpdateRequest, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
}
