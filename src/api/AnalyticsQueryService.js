...
class AnalyticsQueryService {
    ...
    * @param {*} [options] Override http request options.
    */
    fetchResult(id, timeout, maxRows, nextToken, options = {}) {
        ...
        if (timeout !== undefined) {
            localVarQueryParameters['timeout'] = ObjectSerializer_1.ObjectSerializer.serialize(timeout, "number");
        }
        if (maxRows !== undefined) {
            localVarQueryParameters['maxRows'] = ObjectSerializer_1.ObjectSerializer.serialize(maxRows, "number");
        }
        if (nextToken !== undefined) {
            localVarQueryParameters['nextToken'] = ObjectSerializer_1.ObjectSerializer.serialize(nextToken, "string");
        }
        Object.assign(localVarHeaderParams, options.headers);
        let defaultHeaderParams = {
            "x-meta-sdk-version": "3.2.1",
        ...
        return new Promise((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    ...
                    if (response.statusCode) {
                        if (response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer_1.ObjectSerializer.deserialize(body, "AnalyticsQueryResultBatch");
                            return resolve({ response: response, body: body });
                        }
                        else {
                            let errorObject;
    ...
    * @param {*} [options] Override http request options.
    */
    generateDownloadUrl(id, timeout, options = {}) {
        ...
        return new Promise((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    ...
                    if (response.statusCode) {
                        if (response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer_1.ObjectSerializer.deserialize(body, "Array<AnalyticsSchemaTable>");
                            return resolve({ response: response, body: body });
                        }
                        else {
                            let errorObject;
        ...
        return new Promise((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    ...
                    if (response.statusCode) {
                        if (response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer_1.ObjectSerializer.deserialize(body, "AnalyticsQueryExecution");
                            return resolve({ response: response, body: body });
                        }
                        else {
                            let errorObject;
    ...
    */
    submitQuery(query, options = {}) {
        ...
        let localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer_1.ObjectSerializer.serialize(query, "AnalyticsQuery"),
            timeout: this._timeout * 1000
        };
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
