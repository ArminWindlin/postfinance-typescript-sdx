...
declare class TransactionVoidService {
    ...
    * @param {*} [options] Override http request options.
    */
    voidOffline(spaceId: number, id: number, options?: any): Promise<{
        response: http.IncomingMessage;
        body: TransactionVoid;
    }>;
    /**
    ...
    * @param {*} [options] Override http request options.
    */
    voidOnline(spaceId: number, id: number, options?: any): Promise<{
        response: http.IncomingMessage;
        body: TransactionVoid;
    }>;
}
