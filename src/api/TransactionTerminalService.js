    ...
    */
    fetchReceipts(spaceId, request, options = {}) {
        ...
        let localVarRequestOptions = {
            ...
            json: true,
            body: ObjectSerializer_1.ObjectSerializer.serialize(request, "TerminalReceiptFetchRequest"),
                ...
                if (error) {
                    ...
                    if (response.statusCode) {
                        if (response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer_1.ObjectSerializer.deserialize(body, "Array<RenderedTerminalReceipt>");
