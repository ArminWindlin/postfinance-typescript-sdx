...
class TransactionCompletionService {
    ...
    */
    completeOffline(spaceId, id, options = {}) {
                ...
                if (error) {
                    ...
                    if (response.statusCode) {
                        if (response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer_1.ObjectSerializer.deserialize(body, "TransactionCompletion");
    ...
    * @param {*} [options] Override http request options.
    */
    completeOnline(spaceId, id, options = {}) {
    ...
    * @param {*} [options] Override http request options.
    */
    completePartiallyOffline(spaceId, completion, options = {}) {
        ...
        let localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer_1.ObjectSerializer.serialize(completion, "TransactionCompletionRequest"),
            timeout: this._timeout * 1000
        };
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
    ...
    * @param {*} [options] Override http request options.
    */
    completePartiallyOnline(spaceId, completion, options = {}) {
        ...
        return new Promise((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    ...
                    if (response.statusCode) {
                        if (response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer_1.ObjectSerializer.deserialize(body, "Array<TransactionCompletion>");
                            return resolve({ response: response, body: body });
                        }
                        else {
                            let errorObject;
