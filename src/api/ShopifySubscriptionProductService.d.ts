...
declare class ShopifySubscriptionProductService {
    ...
    * @param {*} [options] Override http request options.
    */
    create(spaceId: number, entity: ShopifySubscriptionProductCreate, options?: any): Promise<{
        response: http.IncomingMessage;
        body: ShopifySubscriptionProduct;
    }>;
    /**
    ...
    */
    search(spaceId: number, query: EntityQuery, options?: any): Promise<{
        response: http.IncomingMessage;
        body: Array<ShopifySubscriptionProduct>;
    }>;
    /**
    ...
    * @param {*} [options] Override http request options.
    */
    update(spaceId: number, entity: ShopifySubscriptionProductUpdate, options?: any): Promise<{
        response: http.IncomingMessage;
        body: ShopifySubscriptionProduct;
    }>;
}
