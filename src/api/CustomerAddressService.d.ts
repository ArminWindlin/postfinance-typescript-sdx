...
declare class CustomerAddressService {
    ...
    * @param {*} [options] Override http request options.
    */
    create(spaceId: number, entity: CustomerAddressCreate, options?: any): Promise<{
        response: http.IncomingMessage;
    ...
    * @param {*} [options] Override http request options.
    */
    selectDefaultAddress(spaceId: number, id: number, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    /**
    ...
    * @param {*} [options] Override http request options.
    */
    update(spaceId: number, entity: CustomerAddressActive, options?: any): Promise<{
        response: http.IncomingMessage;
        body: CustomerAddress;
    }>;
}
